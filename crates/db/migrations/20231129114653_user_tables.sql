...
INSERT INTO users(email, hashed_password) VALUES('test1@test1.com', 'asdfasdfasdf');
INSERT INTO users(email, hashed_password) VALUES('test2@test2.com', 'asdfasdfasdf');
INSERT INTO users(email, hashed_password) VALUES('test2@test3.com', 'asdfasdfasdf');
...
CREATE TABLE sessions (
  ...
  , otpt_code_sent BOOLEAN NOT NULL DEFAULT false
);
...
COMMENT ON COLUMN sessions.otp_code_encrypted IS 'A 6 digit code that is encrypted here to prevent attackers with read access to the databse begin able to use it.';
